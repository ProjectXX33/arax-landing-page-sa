          ...
          <div className="space-y-6">
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button 
                size="lg" 
                variant="outline"
                className="border-2 border-white text-white hover:bg-white hover:text-chito-red font-cairo font-bold text-xl px-12 py-6 rounded-2xl transition-all duration-300"
              >
